...
import { CellsListTable } from "@/components/Tables/CellsListTable";
import { Fragment } from "react";

export default async function CellsPage() {

  const cells = await getCellsAction();
  console.log(cells);
          ...
          <div className="col-span-12 h-auto  shadow-default   dark:bg-transparent xl:col-span-12">
            ...
            >
              <div className=" py-2  border-b border-neutral-300 w-full">
                ...
                {cells === null ? <p>Ocorreu um erro ao listar as células</p> : <CellsListTable data={cells} />}
              </div>
            </div>
